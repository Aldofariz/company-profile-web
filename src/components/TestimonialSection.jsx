        ...
        <section className="py-16 px-4 max-w-7xl mx-auto">
            ...
            <Swiper 
                ...
                <div className="flex justify-center gap-4 md:mt-8 mt-4">
                  <button className="swiper-button-prev-custom w-12 h-12 rounded-full flex border border-gray-200 items-center justify-center hover:bg-blue-500 hover:text-white transition-all duration-200 cursor-pointer ">
                    <BsChevronLeft className="size-6"/>
                  </button>
                  <button className="swiper-button-next-custom w-12 h-12 rounded-full flex border border-gray-200 items-center justify-center hover:bg-blue-500 hover:text-white transition-all duration-200 cursor-pointer ">
